<title>Certfication's_Info_Store</title>
...
<div class="container">
	<div class="row">
		<div class="col-md-6 col-md-offset-3 boxStyle" style="padding-right: 0px!important;padding-left: 0px!important;">
		   <div class="panel-body" style="padding-right: 4px!important;padding-left: 4px!important;">
                 <form method="post" name="challenge"  class="form-horizontal" role="form" action="certidata.php" onSubmit="return submitForm()" AUTOCOMPLETE = "off" >
			...
			<legend style="border-bottom: none;width: inherit;!important;padding:inherit;font-family: 'Caveat';" class="legend">Fill the Certifications and Workshop Details</legend>
	     
    <p style=" font-family: 'Federo';font-size:18px" >Enter atleast two Certification Name....!</p>
    ...
    <input type="text" name="cone" id="cone" class="input" required="required">
    ...
    <input type="text" name="ctwo" id="ctwo"  class="input" required="required">
    <div class="line-box" style="width: 600px; height:3px;">
      <div class="line"></div>
    </div>
  </label>
    ...
    <input type="text" name="cthree" id="cthree"  class="input">
    <div class="line-box" style="width: 600px; height:3px;">
      <div class="line"></div>
    </div>
  </label>
    ...
    <input type="text" name="cfour" id="cfour"  class="input" >
    <div class="line-box" style="width: 600px; height:3px;">
      <div class="line"></div>
    </div>
  </label>
    ...
    <input type="text" name="cfive" id="cfive" class="input" >
    <div class="line-box" style="width: 600px; height:3px;">
      <div class="line"></div>
    </div>
  </label>
