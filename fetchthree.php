<?php
        ...
        $query="select * from info where FACULTY_NAME = '". $_SESSION['facultyname'] ."' and YEAR=3 ";
        $result = mysqli_query($con, $query);  
?>
<html>
    <head>
        <title>Third-Year-Details</title>
    ...
    <body>
        <table align="center" border="-5px" style="width:600px;line-height:40px">
                ...
                <p colspan="29" style="font-family: 'Cinzel Decorative';align-content: center;"><h2>3'rd Year Details<h2> <a href="bot.php"><button id="star" type="button" class="btn btn-success" style="font-family: 'Federo';"><i class="fa fa-home"></i>  Go Home....!</button></a></p>
